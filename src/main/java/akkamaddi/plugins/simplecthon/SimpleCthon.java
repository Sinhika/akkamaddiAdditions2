...
public class SimpleCthon
{
    ...
    public static SimpleCthon INSTANCE;

    @SidedProxy(clientSide = "akkamaddi.plugins.simplecthon.ProxyClient", 
                    serverSide = "akkamaddi.plugins.simplecthon.ProxyCommon")
    ...
    {
        if (!SubModHandler.moduleEnabled(SubModHandler.MODULE_CTHON)) 
            return;
